...
import { ArrowLeft, Star, ShoppingBag, CheckCircle2, ShieldCheck, Zap, Check } from "lucide-react";
import Link from "next/link";
import { useCartStore } from "@/data/cartStore";
import { useState } from "react";
import dynamic from "next/dynamic";

const PaystackButton = dynamic(() => import("@/component/PaystackButton"), { ssr: false });
  ...
  return (
    <div className="pt-32 pb-24">
      ...
      <div className="container mx-auto px-6 md:px-12">
        ...
        >
          <ArrowLeft size={20} className="transition-transform group-hover:-translate-x-1" /> Back to Shop
        </button>
          ...
          >
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-500">({product.rating}.0 Rating from 150+ reviews)</span>
              </div>
              <h1 className="text-5xl lg:text-6xl serif leading-tight">{product.name}</h1>
              <p className="text-3xl font-bold text-primary">${product.price}.00</p>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-10 border-t border-secondary">
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-medium">Safe for All Skin Types</span>
              </div>
              <div className="flex items-center gap-3">
                <Zap className="text-primary" size={24} />
                <span className="text-sm font-medium">Fast Visible Results</span>
              </div>
              <div className="flex items-center gap-3">
